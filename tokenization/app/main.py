...
STORAGE_URL = os.getenv("TOKENIZER_STORAGE_URL") or "http://10.152.183.163:9000"
...
TOKEN = os.getenv(
    "TOKENIZER_TOKEN_VALUE") or ""
...
s3.upload_file("./app/data/PAM50_proteins_with_columns.csv", Bucket=DATA_BUCKET,
               Key=f"{DATA_PAM50_PREFIX}/PAM50_proteins_with_columns.csv")
logger.info("Uploaded file: PAM50_proteins_with_columns.csv")
df_breast_cancer = pd.read_csv("./app/data/clinical_data_breast_cancer_with_columns.csv")
...
s3.upload_file("./app/data/77_cancer_proteomes_CPTAC_itraq_with_columns.csv", Bucket=DATA_BUCKET,
